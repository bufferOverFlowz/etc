...
# save last error code if > 0 and display to prompt
...
if [ "$color_prompt" = yes ]; then
    PS1='${debian_chroot:+($debian_chroot)}\[\033[01;32m\]\u@\h\[\033[00m\]:\[\033[01;34m\]\w\[\033[00m\]\$`get_last_exit_status` '
...
alias py='python3'
alias dtm='watch -n1 grep -i dirty /proc/meminfo' #monitors /proc/meminfo every 1 second
